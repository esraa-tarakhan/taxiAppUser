...
class _MainScreenState extends State<MainScreen>
{
  ...
  searchNearestOnlineDrivers() async
  {
    ...
    if(onlineNearByAvailableDriversList.length == 0)
    {
     ...
     SnackBarWidget(msg: "No Online Nearest Driver Available. Search Again after some time, Restarting App Now.");
          ...
          .then((snap)
      {
        if(snap.snapshot.value != null)
        {
              ...
              .onValue.listen((eventSnapshot)
          {
            ...
            {
             SnackBarWidget(msg: "The driver has cancelled your request. Please choose another driver.");
              
              Future.delayed(const Duration(milliseconds: 3000), ()
              {
               SnackBarWidget(msg: "Please Restart App Now.");
        ...
        {
         SnackBarWidget(msg: "This driver do not exist. Try again.");
        }
      });
    }
  }
  ...
  sendNotificationToDriverNow(String chosenDriverId)
  {
        ...
        .child("token").once().then((snap)
    {
      if(snap.snapshot.value != null)
      {
       ...
       SnackBarWidget(msg: "Notification sent Successfully.");
      }
      else
      {
       SnackBarWidget(msg: "Please choose another driver.");
        return;
      }
    });
  }
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        ...
                        onPressed: ()
                        {
                          ...
                          {
                           SnackBarWidget(msg: "Please select destination location");
                          }
                        },
